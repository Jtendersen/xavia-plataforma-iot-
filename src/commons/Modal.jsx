                ...
                <Box sx={style}>
                    ...
                    <div>
                        ...
                        <FormControl fullWidth>
                            ...
                            >
                                <MenuItem value={"Micro Tracker"}>
                                    Micro Tracker
                                </MenuItem>
                                <MenuItem value={"Compact Tracker"}>
                                    Compact Tracker
                                </MenuItem>
                                <MenuItem value={"Industrial Tracker"}>
                                    Industrial Tracker
                                </MenuItem>
                                <MenuItem value={"Smart Badge"}>
                                    Smart Badge
                                </MenuItem>
                            </Select>
                        </FormControl>
                    ...
                    <Box sx={style}>
                        {dataQr ? (
                            <>
                                <Box sx={{ p: 6 }}>
                                    <Typography
                                        ...
                                        sx={{ pb: 4 }}
                                    >
                                        ¿Estás escaneando el dispositivo #
                                        {dataQr}?
                                    </Typography>
                                    <Box textAlign={"center"}>
                                        {/* BUTTON SI */}
                            ...
                            <>
                                ...
                                >
                                    Escanear Código QR que se encuentra en el
                                    dispositivo
                                </Typography>
                                <QrScanner />
                            </>
